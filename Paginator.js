...
import PageJumpTo from '../PageJumpTo/index'
...
class Paginator extends Component {
  constructor(props) {
    ...
    //Vars
    const { allRecords, pageLimit = 10, currentPage = 1, pageNeighbours = 0 } = this.props
    ...
    return (
      <div>
        <nav aria-label="Pagination">
          ...
          {/* <React.Fragment>
            <label htmlFor={inputId} style={{ float: 'left', lineHeight: '2.5em' }}>
              {_get(translations, label, label)}:
            </label>
            <span
              style={{
                display: 'block',
            ...
            >
              <input
                ...
                placeholder={_get(translations, placeholder, placeholder)}
